...
func create_storage_dictionary() -> Dictionary:
	var settings_container_dict : Dictionary = {
		...
		"move_left" : InputMap.action_get_events("left"),
		"move_right" : InputMap.action_get_events("right"),
		"move_up" : InputMap.action_get_events("up"),
		"move_down" : InputMap.action_get_events("down"),
